...
**25 tools.** [`README.md`](../README.md) is the per-parameter reference; this is the shape and the grouping.
...
| Author | `create_layout`, `insert_field`, `insert_label`, `insert_text`, `insert_picture`, `insert_table`, `insert_repeater_table`, `insert_repeater_row`, `insert_subtotal_row` |
